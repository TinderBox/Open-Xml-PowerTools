                ...
                if (element.Name == W.p)
                {
                    ...
                    if (li != null)
                    {
                        ...
                        var listItemRun = new XElement(W.r,
                            ...
                            new XAttribute("data-abstractNumId", abstractNumId),
                            new XAttribute("data-numId", listItemInfo.NumId),
                            new XAttribute("data-numFmt", (string)listItemInfo.Lvl(paragraphLevel).Elements(W.numFmt).Attributes(W.val).FirstOrDefault()),
                            new XAttribute("data-ilvl", paragraphLevel),
                            listItemRunProps,
                            new XElement(W.t,
